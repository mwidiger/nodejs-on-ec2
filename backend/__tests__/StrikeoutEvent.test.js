...
describe('StrikeoutEvent', () => {
  ...
  test('should increment outs by 1', () => {
    const event = new StrikeoutEvent(beforeState, config);
    event.apply();
    expect(event.afterState.outs).toBe(1);
  });

  test('should reset count after strikeout', () => {
    beforeState.balls = 2;
  ...
  test('should advance lineup after strikeout', () => {
